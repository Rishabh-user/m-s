...
function LoyaltyCustomer() {
    const [formData, setFormData] = useState({
      ...
      // Handle items per page change for customer table
        ...
        // Handle items per page change for balance table
                                    ...
                                    <div className="p-5 mt-2.5 flex flex-col gap-5">
                                        <table className="min-w-full leading-normal">
                                            <thead className="bg-black">
                                                <tr>
                                                    <th className="px-5 py-3 border-b dark:border-darkmode-300 whitespace-nowrap text-white text-left">Sr.No</th>
                                            ...
                                            <tbody>
                                                {currentCustomerItems?.map((contact, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="px-5 border-b dark:border-darkmode-300 py-4 border-dashed dark:bg-darkmode-600">{contact.mobile_Phone_No}</td>
